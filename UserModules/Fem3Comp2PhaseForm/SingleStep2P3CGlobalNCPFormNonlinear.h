...
template <
    ...
    >
class SingleStep2P3CGlobalNCPFormNonlinear
...
public:
	...
	SingleStep2P3CGlobalNCPFormNonlinear(MyDiscreteSystem* dis, UserFemProblem* problem, T_USER_FUNCTION_DATA* user_data, MyNonlinearSolverFactory* nl_solver_factory = NULL);

    ///
	virtual ~SingleStep2P3CGlobalNCPFormNonlinear()
    {
...
private:
	DISALLOW_COPY_AND_ASSIGN(SingleStep2P3CGlobalNCPFormNonlinear);
...
template <
    ...
    >
	SingleStep2P3CGlobalNCPFormNonlinear<T_USER_FEM_PROBLEM, T_USER_FUNCTION_DATA, T_LINEAR_SOLVER, T_NL_SOLVER_FACTORY>::SingleStep2P3CGlobalNCPFormNonlinear(MyDiscreteSystem* dis, UserFemProblem* problem, T_USER_FUNCTION_DATA* userData, MyNonlinearSolverFactory* nl_solver_factory)
...
template <
    ...
    class T_NL_SOLVER_FACTORY
    >
	int SingleStep2P3CGlobalNCPFormNonlinear<T_USER_FEM_PROBLEM, T_USER_FUNCTION_DATA, T_LINEAR_SOLVER, T_NL_SOLVER_FACTORY>::solveTimeStep(const NumLib::TimeStep &t_n1)
{
    // time step
