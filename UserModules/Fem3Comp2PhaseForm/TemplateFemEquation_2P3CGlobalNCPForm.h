...
#include "FemResidualEQS_2P3CGlobalNCPForm.h"
#include "FemDxEQS_2P3CGlobalNCPForm.h"
...
>
class TemplateFemEquation_2P3CGlobalNCPForm
{
public:
	...
	typedef TemplateTransientResidualFEMFunction_2P3CGlobalNCPForm<MyDiscreteSystem, T_FUNCTION_DATA, ResidualAssemblerType> ResidualEQSType;
	typedef TemplateTransientDxFEMFunction_2P3CGlobalNCPForm<MyDiscreteSystem, LinearSolverType, T_FUNCTION_DATA, JacobianAssemblerType> DxEQSType;

	TemplateFemEquation_2P3CGlobalNCPForm() :
