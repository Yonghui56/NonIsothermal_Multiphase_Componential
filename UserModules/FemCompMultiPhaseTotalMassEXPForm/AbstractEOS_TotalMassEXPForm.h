...
#ifndef ABSTRACTEOS_TOTALMASSEXPFORM_H 
#define ABSTRACTEOS_TOTALMASSEXPFORM_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_TotalMassEXPForm {
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_TotalMassEXPForm(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_TotalMassEXPForm() {};
