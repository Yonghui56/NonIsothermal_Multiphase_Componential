...
*/
class EOS_TotalMassEXPForm_General : public AbstractEOS_TotalMassEXPForm
{
public:
	...
	/**
	  * Constructor
	  */
	EOS_TotalMassEXPForm_General() : AbstractEOS_TotalMassEXPForm(1)
	{
	};
	...
	/**
	  * DESTRUCTOR
	  */
	virtual ~EOS_TotalMassEXPForm_General()
	{
