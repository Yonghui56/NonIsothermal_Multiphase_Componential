...
#ifndef FUNCTIONCMP_TOTALMASSEXPFORM_H
#define FUNCTIONCMP_TOTALMASSEXPFORM_H
...
#include "UserModules/FemCompMultiPhaseTotalMassEXPForm/NonLinearCMP_TotalMassEXPForm_TimeODELocalAssembler.h"
#include "UserModules/FemCompMultiPhaseTotalMassEXPForm/NonLinearCMP_TotalMassEXPForm_JacobianLocalAssembler.h"
#include "UserModules/FemCompMultiPhaseTotalMassEXPForm/TotalMassEXPForm_Nested_EOS_NRIterationStepInitializer.h"
#include "Fem_CMP_TotalMassEXP_Solution.h"
#include "SingleStepCMP_TotalMassEXPForm.h"
...
class FunctionCMP_TotalMassEXPForm
...
public:
	...
	typedef FunctionCMP_TotalMassEXPForm       MyFunctionData;    // FEM problem class
	...
	// local assembler
	typedef NonLinearCMP_TotalMassEXPForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerEQSLocalAssembler, MyNodalFunctionScalar, FunctionCMP_TotalMassEXPForm>      MyNonLinearAssemblerType;
	typedef NonLinearCMP_TotalMassEXPForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerResidualLocalAssembler, MyNodalFunctionScalar, FunctionCMP_TotalMassEXPForm> MyNonLinearResidualAssemblerType;
	typedef NonLinearCMP_TotalMassEXPForm_JacobianLocalAssembler<MyNodalFunctionScalar, MyFunctionData> MyNonLinearJacobianAssemblerType;
	typedef TotalMassEXPForm_Nested_EOS_NRIterationStepInitializer<MyNodalFunctionScalar, MyFunctionData> MyNRIterationStepInitializer;
	...
	*/
	typedef SolutionLib::FemIVBVProblem<
		MyDiscreteSystem,
		MyNonLinearEquationType
	> MyNonLinearCMPTotalMassEXPFormProblemType;
	...
	*/
	...
	/**
	  ...
	  */
	typedef SolutionLib::Fem_CMP_TotalMassEXP_Solution<MyDiscreteSystem> MyCMPTotalMassEXPFormProblemType;
	typedef SolutionLib::SingleStepCMP_TotalMassEXPForm<MyFunctionData,
		MyCMPTotalMassEXPFormProblemType,
		MyNonLinearCMPTotalMassEXPFormProblemType,
		MyNonLinearSolutionType> MyCMPTotalMassEXPFormSolution;
	typedef typename MyCMPTotalMassEXPFormProblemType::MyVariable MyVariableCMPTotalMassEXPForm;

	/**
	  * constructor
	  */
	FunctionCMP_TotalMassEXPForm()
		: Process("CMP_TotalMassEXPForm", 0, 2),
	...
	/**
	  ...
	  */
	virtual ~FunctionCMP_TotalMassEXPForm()
	{
...
protected:
	...
	/**
	  ...
	  */
	virtual MyCMPTotalMassEXPFormSolution* getSolution() { return _solution; };
...
private:
	DISALLOW_COPY_AND_ASSIGN(FunctionCMP_TotalMassEXPForm);
...
private:
	...
	* non-linear problem
	*/
	MyNonLinearCMPTotalMassEXPFormProblemType*     _non_linear_problem;
	...
	*/
	...
	/**
	  ...
	  */
	MyCMPTotalMassEXPFormProblemType* _problem;

	/**
	  * solution class for the component based multiphase flow problem
	  */
	MyCMPTotalMassEXPFormSolution*    _solution;
...
#include "FunctionCMP_TotalMassEXPForm.hpp"
