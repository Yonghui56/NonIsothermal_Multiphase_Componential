...
bool FunctionCMP_TotalMassEXPForm<T1, T2>::initialize(const BaseLib::Options &option)
{
	...
	_problem = new MyCMPTotalMassEXPFormProblemType(dis);
	_problem->setTimeSteppingFunction(*tim);  // applying the time stepping function
	
	// creating mean pressure vector
	MyVariableCMPTotalMassEXPForm* mean_pressure = _problem->addVariable("MEAN_PRESSURE");
	...
	MyVariableCMPTotalMassEXPForm* total_mass_density = _problem->addVariable("TOTAL_MASS_DENSITY");
	...
	*/
	...
	_non_linear_problem = new MyNonLinearCMPTotalMassEXPFormProblemType(dis);
	...
	// set up solution
	_solution = new MyCMPTotalMassEXPFormSolution(dis, _problem, _non_linear_solution, this);
	/**
...
template <class T1, class T2>
void FunctionCMP_TotalMassEXPForm<T1, T2>::initializeTimeStep(const NumLib::TimeStep &/*time*/)
{
	/*
	size_t i;
...
template <class T1, class T2>
void FunctionCMP_TotalMassEXPForm<T1, T2>::updateOutputParameter(const NumLib::TimeStep &/*time*/)
{

}

template <class T1, class T2>
void FunctionCMP_TotalMassEXPForm<T1, T2>::output(const NumLib::TimeStep &/*time*/)
{
...
template <class T1, class T2>
void FunctionCMP_TotalMassEXPForm<T1, T2>::calc_nodal_eos_sys(double dt = 0.0)
{
