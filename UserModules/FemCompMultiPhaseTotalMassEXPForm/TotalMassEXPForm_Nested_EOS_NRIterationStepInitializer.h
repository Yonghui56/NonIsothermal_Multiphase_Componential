...
#ifndef TOTALMASSEXPFORM_NESTED_EOS_NR_ITERATION_STEP_INITIALIZER_H
#define TOTALMASSEXPFORM_NESTED_EOS_NR_ITERATION_STEP_INITIALIZER_H

#include "NonLinearCMP_TotalMassEXPForm_JacobianLocalAssembler.h"
...
class TotalMassEXPForm_Nested_EOS_NRIterationStepInitializer
{
public:
	TotalMassEXPForm_Nested_EOS_NRIterationStepInitializer(
		NonLinearCMP_TotalMassEXPForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerResidualLocalAssembler, T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA>* assemblerR,
		NonLinearCMP_TotalMassEXPForm_JacobianLocalAssembler<T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA> *assemblerJ)
...
private:
	...
	*/
	NonLinearCMP_TotalMassEXPForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerResidualLocalAssembler, T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA>* _assemblerR;

	/**
	* pointer to assemblerJ
	*/
	NonLinearCMP_TotalMassEXPForm_JacobianLocalAssembler<T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA>* _assemblerJ;
