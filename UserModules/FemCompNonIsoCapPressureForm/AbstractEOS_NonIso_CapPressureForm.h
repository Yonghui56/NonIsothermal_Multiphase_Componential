...
#ifndef ABSTRACTEOS_NONISO_CAPPRESSUREFORM_H 
#define ABSTRACTEOS_NONISO_CAPPRESSUREFORM_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_NonIso_CapPressureForm {
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_NonIso_CapPressureForm(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_NonIso_CapPressureForm() {};
