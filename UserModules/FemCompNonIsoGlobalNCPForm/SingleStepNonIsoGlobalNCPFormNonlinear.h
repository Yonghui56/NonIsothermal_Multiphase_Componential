...
template <
    ...
    >
class SingleStepNonIsoGlobalNCPFormNonlinear
...
public:
	...
	SingleStepNonIsoGlobalNCPFormNonlinear(MyDiscreteSystem* dis, UserFemProblem* problem, T_USER_FUNCTION_DATA* user_data, MyNonlinearSolverFactory* nl_solver_factory = NULL);

    ///
	virtual ~SingleStepNonIsoGlobalNCPFormNonlinear()
    {
...
private:
	DISALLOW_COPY_AND_ASSIGN(SingleStepNonIsoGlobalNCPFormNonlinear);
...
template <
    ...
    >
SingleStepNonIsoGlobalNCPFormNonlinear<T_USER_FEM_PROBLEM, T_USER_FUNCTION_DATA, T_LINEAR_SOLVER, T_NL_SOLVER_FACTORY>::SingleStepNonIsoGlobalNCPFormNonlinear(MyDiscreteSystem* dis, UserFemProblem* problem, T_USER_FUNCTION_DATA* userData, MyNonlinearSolverFactory* nl_solver_factory)
...
template <
    ...
    class T_NL_SOLVER_FACTORY
    >
	int SingleStepNonIsoGlobalNCPFormNonlinear<T_USER_FEM_PROBLEM, T_USER_FUNCTION_DATA, T_LINEAR_SOLVER, T_NL_SOLVER_FACTORY>::solveTimeStep(const NumLib::TimeStep &t_n1)
{
    // time step
