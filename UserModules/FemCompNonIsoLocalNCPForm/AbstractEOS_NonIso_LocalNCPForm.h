...
#ifndef ABSTRACTEOS_NONISO_LOCALNCPFORM_H 
#define ABSTRACTEOS_NONISO_LOCALNCPFORM_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_NonIso_LocalNCPForm{
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_NonIso_LocalNCPForm(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_NonIso_LocalNCPForm() {};
