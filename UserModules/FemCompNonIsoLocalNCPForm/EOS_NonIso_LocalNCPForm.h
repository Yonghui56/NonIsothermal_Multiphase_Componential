 ...
 */
class EOS_NonIso_LocalNCPForm : public AbstractEOS_NonIso_LocalNCPForm
{
public:
	...
	/**
	  * Constructor
	  */
	EOS_NonIso_LocalNCPForm() : AbstractEOS_NonIso_LocalNCPForm(3)
    {
    };
	...
	/**
	  * DESTRUCTOR
	  */
	virtual ~EOS_NonIso_LocalNCPForm()
    {
