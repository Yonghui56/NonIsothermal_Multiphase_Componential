...
#ifndef FUNCTIONCMP_NONISO_LOCALNCPFORM_H
#define FUNCTIONCMP_NONISO_LOCALNCPFORM_H
...
#include "UserModules/FemCompNonIsoLocalNCPForm/NonLinearCMP_NonIso_LocalNCPForm_TimeODELocalAssembler.h"
#include "UserModules/FemCompNonIsoLocalNCPForm/NonLinearCMP_NonIso_LocalNCPForm_JacobianLocalAssembler.h"
#include "UserModules/FemCompNonIsoLocalNCPForm/NonIso_LocalNCPForm_Nested_EOS_NRIterationStepInitializer.h"
#include "Fem_CMP_NonIso_LocalNCP_Solution.h"
#include "SingleStepCMP_NonIso_LocalNCPForm.h"
...
class FunctionCMP_NonIso_LocalNCPForm
...
public:
	...
	enum In {};//Velocity = 0 
	// no output variable
	enum Out { Mean_Pressure = 0, Total_Mass_Density = 0 ,Temperature=0};
	...
	typedef FunctionCMP_NonIso_LocalNCPForm       MyFunctionData;    // FEM problem class
	...
	// local assembler
	typedef NonLinearCMP_NonIso_LocalNCPForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerEQSLocalAssembler, MyNodalFunctionScalar, FunctionCMP_NonIso_LocalNCPForm>      MyNonLinearAssemblerType;
	typedef NonLinearCMP_NonIso_LocalNCPForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerResidualLocalAssembler, MyNodalFunctionScalar, FunctionCMP_NonIso_LocalNCPForm> MyNonLinearResidualAssemblerType;
	typedef NonLinearCMP_NonIso_LocalNCPForm_JacobianLocalAssembler<MyNodalFunctionScalar, MyFunctionData> MyNonLinearJacobianAssemblerType;
	typedef NonIso_LocalNCPForm_Nested_EOS_NRIterationStepInitializer<MyNodalFunctionScalar, MyFunctionData> MyNRIterationStepInitializer;
	...
	*/
	typedef SolutionLib::FemIVBVProblem<
		MyDiscreteSystem,
		MyNonLinearEquationType
	> MyNonLinearCMPLocalNCPFormProblemType;
	...
	*/
	...
	/**
	  ...
	  */
	typedef SolutionLib::Fem_CMP_NonIso_LocalNCP_Solution<MyDiscreteSystem> MyCMPLocalNCPFormProblemType;
	typedef SolutionLib::SingleStepCMP_NonIso_LocalNCPForm<MyFunctionData,
		MyCMPLocalNCPFormProblemType,
		MyNonLinearCMPLocalNCPFormProblemType,
		MyNonLinearSolutionType> MyCMPLocalNCPFormSolution;
	typedef typename MyCMPLocalNCPFormProblemType::MyVariable MyVariableCMPLocalNCPForm;

	/**
	  * constructor
	  */
	FunctionCMP_NonIso_LocalNCPForm()
		: Process("CMP_NonIso_LocalNCPForm", 0, 3),
	...
	/**
	  ...
	  */
	virtual ~FunctionCMP_NonIso_LocalNCPForm()
	{
...
protected:
	...
	/**
	  ...
	  */
	virtual MyCMPLocalNCPFormSolution* getSolution() { return _solution; };
...
private:
	DISALLOW_COPY_AND_ASSIGN(FunctionCMP_NonIso_LocalNCPForm);
...
private:
	...
	* non-linear problem
	*/
	MyNonLinearCMPLocalNCPFormProblemType*     _non_linear_problem;
	...
	*/
	...
	/**
	  ...
	  */
	MyCMPLocalNCPFormProblemType* _problem;

	/**
	  * solution class for the component based multiphase flow problem
	  */
	MyCMPLocalNCPFormSolution*    _solution;
...
#include "FunctionCMP_NonIso_LocalNCPForm.hpp"
