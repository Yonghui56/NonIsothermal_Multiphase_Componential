...
#ifndef LOCAL_PROBLEM_EOS_NonIso_LocalNCP_H
#define LOCAL_PROBLEM_EOS_NonIso_LocalNCP_H
...
/**
  ...
  */
class LocalProblem_EOS_NonIso_LocalNCP
{
public:
	/**
      * constructor of the class
      */
	LocalProblem_EOS_NonIso_LocalNCP();
	
	/**
      * destructor of the class
      */
	~LocalProblem_EOS_NonIso_LocalNCP(void);
...
private:
	...
	/**
	  ...
	  */
	AbstractEOS_NonIso_LocalNCPForm * _EOS;
