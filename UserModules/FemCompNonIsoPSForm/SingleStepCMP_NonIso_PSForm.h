...
#ifndef SINGLE_STEP_CMP_NONISO_CAPPRESSURE_FORM_H 
#define SINGLE_STEP_CMP_NONISO_CAPPRESSURE_FORM_H 
...
>
class SingleStepCMP_NonIso_CapPressureForm
...
public:
	...
	*/
	SingleStepCMP_NonIso_CapPressureForm(MyDiscreteSystem*      dis,
	...
	*/
	virtual ~SingleStepCMP_NonIso_CapPressureForm()
	{
		/*
...
private:
	DISALLOW_COPY_AND_ASSIGN(SingleStepCMP_NonIso_CapPressureForm);
...
template <
	...
	class T_USER_NON_LINEAR_SOLUTION
>
SingleStepCMP_NonIso_CapPressureForm<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
::SingleStepCMP_NonIso_CapPressureForm(MyDiscreteSystem*                dis,
                           UserFemProblem*                  problem,
						   UserNonLinearSolution*           nlin_solution,
						   UserFunctionData*                function_data)
...
_problem(problem), _nlin_solution(nlin_solution), _discrete_system(dis), _function_data(function_data)
{
	...
	INFO("->Setting up a solution algorithm for CMP_NonIso_CapPressureForm problem.");
...
template <class T_USER_FUNCTION_DATA,
		  ...
		  class T_USER_NON_LINEAR_PROBLEM,
		  class T_USER_NON_LINEAR_SOLUTION>
int SingleStepCMP_NonIso_CapPressureForm<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
::solveTimeStep(const NumLib::TimeStep &t_n1)
{
	// print solving information
	INFO("--Solving nonlinear equation for the CMP_NonIso_CapPressureForm process. \n");
