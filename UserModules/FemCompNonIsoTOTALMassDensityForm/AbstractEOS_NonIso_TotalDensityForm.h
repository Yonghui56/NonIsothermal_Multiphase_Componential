...
#ifndef ABSTRACTEOS_NONISO_TOTALDENSITYFORM_H 
#define ABSTRACTEOS_NONISO_TOTALDENSITYFORM_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_NonIso_TotalDensityForm {
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_NonIso_TotalDensityForm(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_NonIso_TotalDensityForm() {};
