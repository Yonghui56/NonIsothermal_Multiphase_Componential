 ...
 */
class EOS_NonIso_TotalDensityForm : public AbstractEOS_NonIso_TotalDensityForm
{
public:
	...
	/**
	  * Constructor
	  */
	EOS_NonIso_TotalDensityForm() : AbstractEOS_NonIso_TotalDensityForm(3)
    {
    };
	...
	/**
	  * DESTRUCTOR
	  */
	virtual ~EOS_NonIso_TotalDensityForm()
    {
	...
	*/
	virtual double get_overall_Heat_Capacity(double Sg, double lambda_pm_dry = 1.85, double lambda_pm_wet = 2.67)
	{
		double lambda_pm(0);
