...
#ifndef FUNCTIONCMP_NONISO_TOTALDENSITYFORM_H
#define FUNCTIONCMP_NONISO_TOTALDENSITYFORM_H
...
#include "UserModules/FemCompNonIsoTOTALMassDensityForm/NonLinearCMP_NonIso_TotalDensityForm_TimeODELocalAssembler.h"
#include "UserModules/FemCompNonIsoTOTALMassDensityForm/NonLinearCMP_NonIso_TotalDensityForm_JacobianLocalAssembler.h"
#include "UserModules/FemCompNonIsoTOTALMassDensityForm/NonIso_TotalDensityForm_Nested_EOS_NRIterationStepInitializer.h"
#include "Fem_CMP_NonIso_TotalDensity_Solution.h"
#include "SingleStepCMP_NonIso_TotalDensityForm.h"
...
class FunctionCMP_NonIso_TotalDensityForm
...
public:
	...
	typedef FunctionCMP_NonIso_TotalDensityForm       MyFunctionData;    // FEM problem class
	...
	// local assembler
	typedef NonLinearCMP_NonIso_TotalDensityForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerEQSLocalAssembler, MyNodalFunctionScalar, FunctionCMP_NonIso_TotalDensityForm>      MyNonLinearAssemblerType;
	typedef NonLinearCMP_NonIso_TotalDensityForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerResidualLocalAssembler, MyNodalFunctionScalar, FunctionCMP_NonIso_TotalDensityForm> MyNonLinearResidualAssemblerType;
	typedef NonLinearCMP_NonIso_TotalDensityForm_JacobianLocalAssembler<MyNodalFunctionScalar, MyFunctionData> MyNonLinearJacobianAssemblerType;
	typedef NonIso_TotalDensityForm_Nested_EOS_NRIterationStepInitializer<MyNodalFunctionScalar, MyFunctionData> MyNRIterationStepInitializer;
	...
	*/
	...
	/**
	  ...
	  */
	typedef SolutionLib::Fem_CMP_NonIso_TotalDensity_Solution<MyDiscreteSystem> MyCMPTotalDensityFormProblemType;
	typedef SolutionLib::SingleStepCMP_NonIso_TotalDensityForm<MyFunctionData,
	...
	/**
	  * constructor
	  */
	FunctionCMP_NonIso_TotalDensityForm()
		: Process("CMP_NonIso_TotalDensityForm", 0, 3),
	...
	/**
	  ...
	  */
	virtual ~FunctionCMP_NonIso_TotalDensityForm()
	{
...
private:
	DISALLOW_COPY_AND_ASSIGN(FunctionCMP_NonIso_TotalDensityForm);
...
#include "FunctionCMP_NonIso_TotalDensityForm.hpp"
