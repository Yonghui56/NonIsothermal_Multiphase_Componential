...
/**
  ...
  */
LocalProblem_EOS_NonIso_TotalDensity::LocalProblem_EOS_NonIso_TotalDensity()
{
...
/**
  ...
  */
LocalProblem_EOS_NonIso_TotalDensity::~LocalProblem_EOS_NonIso_TotalDensity(void)
{
 ...
 */
void LocalProblem_EOS_NonIso_TotalDensity::solve(ogsChem::LocalVector & Input, ogsChem::LocalVector & Output)
{
	...
	{		
		...
		U_ini = Output.head(2);
		if (Input(1) < 0){
			U_cur = MathLib::LocalVector::Zero(N);
			U_cur(0) = 0.0;
			U_cur(1) = Input(0);
		}
		else{
...
/**
  ...
  */
void LocalProblem_EOS_NonIso_TotalDensity::solve_minimization(ogsChem::LocalMatrix & J,
...
/**
  ...
  */
void LocalProblem_EOS_NonIso_TotalDensity::solve_LocalProblem_Newton_LineSearch(std::size_t & flag)
{
