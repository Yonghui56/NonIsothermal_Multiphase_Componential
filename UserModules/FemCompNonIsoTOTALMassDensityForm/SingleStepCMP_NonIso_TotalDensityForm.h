...
#ifndef SINGLE_STEP_CMP_NONISO_TOTALDENSITY_FORM_H 
#define SINGLE_STEP_CMP_NONISO_TOTALDENSITY_FORM_H 
...
>
class SingleStepCMP_NonIso_TotalDensityForm
...
public:
	...
	*/
	SingleStepCMP_NonIso_TotalDensityForm(MyDiscreteSystem*      dis,
	...
	*/
	virtual ~SingleStepCMP_NonIso_TotalDensityForm()
	{
		/*
...
private:
	DISALLOW_COPY_AND_ASSIGN(SingleStepCMP_NonIso_TotalDensityForm);
...
template <
	...
	class T_USER_NON_LINEAR_SOLUTION
>
SingleStepCMP_NonIso_TotalDensityForm<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
::SingleStepCMP_NonIso_TotalDensityForm(MyDiscreteSystem*                dis,
                           UserFemProblem*                  problem,
						   UserNonLinearSolution*           nlin_solution,
						   UserFunctionData*                function_data)
...
_problem(problem), _nlin_solution(nlin_solution), _discrete_system(dis), _function_data(function_data)
{
	...
	INFO("->Setting up a solution algorithm for CMP_NonIso_TotalDensityForm problem.");
...
template <class T_USER_FUNCTION_DATA,
		  ...
		  class T_USER_NON_LINEAR_PROBLEM,
		  class T_USER_NON_LINEAR_SOLUTION>
int SingleStepCMP_NonIso_TotalDensityForm<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
::solveTimeStep(const NumLib::TimeStep &t_n1)
{
	// print solving information
	INFO("--Solving nonlinear equation for the CMP_NonIso_TotalDensityForm process. \n");
	...
	_function_data->set_T(_nlin_solution->getCurrentSolution(2));
