 ...
 *
 * Created on 2016-04-28 by Yonghui Huang
 */
 
#ifndef ABSTRACTEOS_NONISOTOTALMASSEXPFORM_H 
#define ABSTRACTEOS_NONISOTOTALMASSEXPFORM_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_NonIsoTotalMassEXPForm {
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_NonIsoTotalMassEXPForm(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_NonIsoTotalMassEXPForm() {};
	...
	virtual double get_P_sat(double PG, double T) = 0;
	/**
