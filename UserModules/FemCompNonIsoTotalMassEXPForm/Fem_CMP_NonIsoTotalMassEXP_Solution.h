...
#ifndef FEM_CMP_NONISOTOTALMASSEXP_SOLUTION_H
#define FEM_CMP_NONISOTOTALMASSEXP_SOLUTION_H
...
namespace SolutionLib
{
	...
	*/
	...
	class Fem_CMP_NonIsoTotalMassEXP_Solution : public TimeSteppingProblem
	{
	public:
		...
		/**
		  * constructor
		  */
		explicit Fem_CMP_NonIsoTotalMassEXP_Solution(MyDiscreteSystem* dis)
		...
		/**
		  * destructor
		  */
		virtual ~Fem_CMP_NonIsoTotalMassEXP_Solution()
		{
	...
	private:
		DISALLOW_COPY_AND_ASSIGN(Fem_CMP_NonIsoTotalMassEXP_Solution);
