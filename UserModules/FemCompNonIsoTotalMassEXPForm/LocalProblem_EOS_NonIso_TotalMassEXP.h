...
#ifndef LOCAL_PROBLEM_EOS_NonIso_TOTALMASSEXP_H
#define LOCAL_PROBLEM_EOS_NonIso_TOTALMASSEXP_H
...
/**
  ...
  */
class LocalProblem_EOS_NonIso_TotalMassEXP
{
public:
	/**
      * constructor of the class
      */
	LocalProblem_EOS_NonIso_TotalMassEXP();
	
	/**
      * destructor of the class
      */
	~LocalProblem_EOS_NonIso_TotalMassEXP(void);
...
private:
	...
	*/
	...
	/**
	  ...
	  */
	AbstractEOS_NonIsoTotalMassEXPForm * _EOS;
	...
	void solve_LocalProblem_DirectSolve(std::size_t & flag);
};
