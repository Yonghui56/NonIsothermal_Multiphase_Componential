...
#ifndef SINGLE_STEP_CMP_NONISOTOTALMASSEXP_FORM_H 
#define SINGLE_STEP_CMP_NONISOTOTALMASSEXP_FORM_H 
...
>
class SingleStepCMP_NonIsoTotalMassEXPForm
...
public:
	...
	*/
	SingleStepCMP_NonIsoTotalMassEXPForm(MyDiscreteSystem*      dis,
	...
	*/
	virtual ~SingleStepCMP_NonIsoTotalMassEXPForm()
	{
		/*
...
private:
	DISALLOW_COPY_AND_ASSIGN(SingleStepCMP_NonIsoTotalMassEXPForm);
...
template <
	...
	class T_USER_NON_LINEAR_SOLUTION
>
SingleStepCMP_NonIsoTotalMassEXPForm<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
::SingleStepCMP_NonIsoTotalMassEXPForm(MyDiscreteSystem*                dis,
                           UserFemProblem*                  problem,
						   UserNonLinearSolution*           nlin_solution,
						   UserFunctionData*                function_data)
...
template <class T_USER_FUNCTION_DATA,
		  ...
		  class T_USER_NON_LINEAR_PROBLEM,
		  class T_USER_NON_LINEAR_SOLUTION>
			  int SingleStepCMP_NonIsoTotalMassEXPForm<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
