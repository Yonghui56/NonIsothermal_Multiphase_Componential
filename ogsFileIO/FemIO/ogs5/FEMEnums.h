...
enum ProcessType
{
	...
	CMP_NonIso_TotalDensityForm,                  //!< COMPONENT BASED MULTIPHASE FLOW WITH MEAN PRESSURE AND TOTAL MASS DENSITY AS PRIMARY VARIABLE
	CMP_NonIso_CapPressureForm,
	CMP_NonIso_GlobalNCPForm,             //!<COMPONENT BASED MULTIPHASE FLOW WITH COMPLEMENTARY CONDITIONS ON GLOBAL PROBLEM>
	CMP_NonIso_LocalNCPForm,              //!<COMPONENT BASED MULTIPHASE FLOW WITH COMPLEMENTARY CONDITIONS ON LOCAL PROBLEM>
	CMP_2P3CGlobalNCPForm,					//!<COMPONENT BASED TWO-PHASE 3-COMPONENT FLOW WITH GLOBAL COMPLEMENTARY PROBLEM >
	CMP_TotalMassEXPForm,                   //!<COMPONENT BASED TWO-PHASE 2-COMPONENT FLOW total mass density without NCP >
	CMP_NonIsoTotalMassEXPForm,				//!<COMPONENT BASED NON-ISOTHERMAL 2-PHASE 2-COMPONENT FLOW total mass density with NCP >
